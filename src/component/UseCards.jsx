...
const UseCards = () => {
  ...
  return (
    <section className="w-full relative bg-linear-to-r from-[#081025] via-[#0b1c3d] to-[#081025]  py-12 px-6 md:px-16 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-12">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 md:gap-6 w-full lg:w-auto">
          {stats.map((item, idx) => (
            <div key={idx} className={`flex flex-col items-center gap-2 p-6 w-full sm:w-40 rounded-2xl bg-linear-to-br ${item.color} border ${item.border} backdrop-blur-md hover:-translate-y-1.25 transition-all duration-300 group shadow-xl`}>
        ...
        <a 
          ...
          target="#" 
          rel="#"
          className="group relative flex items-center justify-between p-1 rounded-3xl bg-linear-to-r from-blue-300 via-purple-300 to-pink-200 w-full lg:max-w-md shadow-[0_0_30px_rgba(59,130,246,0.3)] hover:shadow-[0_0_50px_rgba(168,85,247,0.5)] transition-all duration-500"
        >
          <div className="flex items-center gap-6 bg-[#0b1224] w-full h-full rounded-[calc(1rem-1px)] p-6 transition-colors group-hover:bg-[#0f1930]">
            ...
            <div className="relative shrink-0">
              ...
              <div className="relative z-10 w-14 h-14 flex items-center justify-center rounded-full bg-linear-to-br from-white to-gray-300 text-[#060b1a] shadow-lg group-hover:scale-110 transition-transform duration-500">
            ...
            <div className="flex flex-col">
              ...
              <h3 className="text-xl font-bold text-white group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-linear-to-r group-hover:from-blue-400 group-hover:to-purple-400 transition-all">
                  Watch <br /> Cloud Setup
              </h3>
              <p className="text-gray-500 text-sm mt-1">See how it works in 2 minutes</p>
            </div>

            {/* Shimmer Overlay */}
            <div className="absolute inset-0 w-full h-full bg-linear-to-r from-transparent via-white/5 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000 ease-in-out"></div>
          </div>
        </a>
